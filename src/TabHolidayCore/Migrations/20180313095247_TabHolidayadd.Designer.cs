...
namespace TabHolidayCore.Migrations
{
    ...
    [Migration("20180313095247_TabHolidayadd")]
    partial class TabHolidayadd
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("TabHolidayCore.Models.BlackOut", b =>
                {
                    b.Property<short>("BlackOutId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.FoodType", b =>
                {
                    b.Property<short>("FoodTypeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.HotelFacility", b =>
                {
                    b.Property<short>("HotelFacilityId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.HotelMeal", b =>
                {
                    b.Property<short>("HotelMealId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("HotelMealId");

                    b.HasIndex("HotelId");

                    b.HasIndex("MealId");

                    b.ToTable("HotelMeals");
                });

            modelBuilder.Entity("TabHolidayCore.Models.Inclusion", b =>
                {
                    b.Property<long>("InclusionId")
                        .ValueGeneratedOnAdd();

                    b.Property<short>("DurationHour");

                    b.Property<short>("DurationMinute");

                    b.Property<short>("InclusionTypeId");
            ...
            modelBuilder.Entity("TabHolidayCore.Models.InclusionType", b =>
                {
                    b.Property<short>("InclusionTypeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.RestaurantType", b =>
                {
                    b.Property<short>("RestaurantTypeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.SightSeeing", b =>
                {
                    b.Property<int>("SightSeeingId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<decimal>("PTAdult");

                    b.Property<decimal>("PTChild");

                    b.Property<decimal>("PTInfant");

                    b.Property<decimal>("SICAdult");

                    b.Property<decimal>("SICChild");

                    b.Property<decimal>("SICInfant");

                    b.Property<bool>("Saturday");

                    b.Property<short>("SightSeeingCategoryId");

                    b.Property<int>("StarRatingId");

                    b.Property<bool>("Sunday");

                    b.Property<decimal>("TOAdult");

                    b.Property<decimal>("TOChild");

                    b.Property<decimal>("TOInfant");
            ...
            modelBuilder.Entity("TabHolidayCore.Models.SightSeeingCategory", b =>
                {
                    b.Property<short>("SightSeeingCategoryId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.TabMeal", b =>
                {
                    b.Property<int>("TabMealId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<short>("ClosingMinute");
                    ...
                    b.Property<short>("OpeningMinute");
            ...
            modelBuilder.Entity("TabHolidayCore.Models.TimeSlot", b =>
                {
                    ...
                    b.Property<short>("EndMinute");

                    b.Property<int?>("SightSeeingId");

                    b.Property<short>("StartHour");

                    b.Property<short>("StartMinute");
            ...
            modelBuilder.Entity("TabHolidayCore.Models.Transfer", b =>
                {
                    b.Property<int>("TransferId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<DateTime>("PremiumDateEndDate");

                    b.Property<DateTime>("PremiumDateStartDate");
                    ...
                    b.Property<short>("TransferCategoryId");

                    b.Property<short>("TransferTypeId");
            ...
            modelBuilder.Entity("TabHolidayCore.Models.TransferCategory", b =>
                {
                    b.Property<short>("TransferCategoryId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.TransferType", b =>
                {
                    b.Property<short>("TransferTypeId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TabHolidayCore.Models.VehicleType", b =>
                {
            ...
            modelBuilder.Entity("TabHolidayCore.Models.BlackOut", b =>
                {
                    b.HasOne("TabHolidayCore.Models.Transfer")
                        .WithMany("BlackOuts")
            ...
            modelBuilder.Entity("TabHolidayCore.Models.HotelFacility", b =>
                {
                    b.HasOne("TabHolidayCore.Models.Facility", "Facility")
                        .WithMany()
            ...
            modelBuilder.Entity("TabHolidayCore.Models.HotelMeal", b =>
                {
                    ...
                    b.HasOne("TabHolidayCore.Models.Meal", "Meal")
                        .WithMany()
            ...
            modelBuilder.Entity("TabHolidayCore.Models.Inclusion", b =>
                {
                    b.HasOne("TabHolidayCore.Models.InclusionType", "InclusionType")
                        .WithMany()
                        .HasForeignKey("InclusionTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TabHolidayCore.Models.SightSeeing")
                        .WithMany("Inclusions")
            ...
            modelBuilder.Entity("TabHolidayCore.Models.SightSeeing", b =>
                {
                    b.HasOne("TabHolidayCore.Models.SightSeeingCategory", "SightSeeingCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("TabHolidayCore.Models.TabMeal", b =>
                {
                    b.HasOne("TabHolidayCore.Models.FoodType", "FoodType")
                        .WithMany()
                        .HasForeignKey("FoodTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TabHolidayCore.Models.RestaurantType", "RestaurantType")
                        .WithMany()
            ...
            modelBuilder.Entity("TabHolidayCore.Models.Transfer", b =>
                {
                    b.HasOne("TabHolidayCore.Models.TransferCategory", "TransferCategory")
                        .WithMany()
                        .HasForeignKey("TransferCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("TabHolidayCore.Models.TransferType", "TransferType")
                        .WithMany()
